...
def get_params():
    params = {
        'weight': 'E:/MOGUI/RT-DETR/runs/train/exp/weights/best.pt',  # 训练出来的权重文件
        'cfg': 'ultralytics/cfg/models/rt-detr/rtdetr-r18.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'testset/000323_jpg.rf.81de16cd450a9f0147e7004d7fd240b8_4_random_color_shift.jpg', 'result')